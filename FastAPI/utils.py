...
def upload_video(file_path, upload_path, bucket_name="heyi-storage"):
    ...
    """
    storage_client = storage.Client.from_service_account_json("./hey-i-375802-e6e402d22694.json")
...
if __name__=="__main__":
    # FINAL_PRO... 여기서 실행해야함
    upload_video(file_path="./streamlit/recording.webm",upload_path="백우열_2762/recording.webm")
    download_video(storage_path="백우열_2762/recording.webm",download_path="./streamlit/recording2.webm")