...
def main():
    ...
    times = {"shoulder": defaultdict(), "hand": defaultdict()}
    ...
    for frame_id, cur_frame in enumerate(mmcv.track_iter_progress(video)):
        ...
        # print("\n")
        # print("left shoulder: ", keypoints[5])
        # print("right shoulder: ", keypoints[6])
        # print("left wrist: ", keypoints[9])
        # print("right wrist: ", keypoints[10])
